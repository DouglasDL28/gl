...
class Renderer(object):
    ...
    def translateCam(self, x, y, z):
        self.camPos = glm.vec3(x,y,z)

    def rotateCam(self, x, y, z):
        self.camRot = glm.vec3(x,y,z)
    ...
    def render(self):
        ...
        camPitch = glm.rotate(i, glm.radians( self.camRot[0] ), glm.vec3(1,0,0))
        camYaw   = glm.rotate(i, glm.radians( self.camRot[1] ), glm.vec3(0,1,0))
        camRoll  = glm.rotate(i, glm.radians( self.camRot[2] ), glm.vec3(0,0,1))
