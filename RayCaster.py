...
bg = pygame.image.load('textures/diamond.png')
...
def main_menu ():
    ...
    while True:
        screen.blit(bg, (0, 0))
        draw_text('Menú principal', font, (255, 255, 255), screen, 20, 20)
        ...
        if button_1.collidepoint(mx, my): # Inicio
            if click: 
                game()
        if button_2.collidepoint(mx, my): # Salida
            if click:
                pygame.quit()
                sys.exit()
