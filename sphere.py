...
class AABB(object):
    def __init__(self, position, size, material):
        ...
        self.planes.append( Plane( glMath.add(position, V3(halfSize,0,0)), V3(1,0,0), material))
        self.planes.append( Plane( glMath.add(position, V3(-halfSize,0,0)), V3(-1,0,0), material))

        self.planes.append( Plane( glMath.add(position, V3(0,halfSize,0)), V3(0,1,0), material))
        self.planes.append( Plane( glMath.add(position, V3(0,-halfSize,0)), V3(0,-1,0), material))

        self.planes.append( Plane( glMath.add(position, V3(0,0,halfSize)), V3(0,0,1), material))
        self.planes.append( Plane( glMath.add(position, V3(0,0,-halfSize)), V3(0,0,-1), material))
